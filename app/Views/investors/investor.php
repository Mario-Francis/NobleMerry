...
<div class="row">
    ...
    <?php endif ?>
    <div class="col-xl-6 col-md-12 col-12 my-2">
        <div class="card shadow-sm">
            <div class="card-header">
                <h6 class="m-0">Accounts
                    <!-- <span  class="float-right"><a id="editNokBtn"  class="btn-link" href="javascript:void(0);" title="Edit"><i class="fa fa-edit"></i></a></span> -->
                </h6>
            </div>
            <div class="card-body">
...
<script src="<?= base_url('d_assets/js/investor.js') ?>"></script>
<?= $this->endSection() ?>