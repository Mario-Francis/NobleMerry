...
<div class="row">
    <div class="col-12">
        <?php if (!$session->get('identity')['has_account']) : ?>
            <div class="alert alert-info" id="regDiv">
                <h4>Welcome <?= $session->get('identity')['first_name'] ?>!</h4>
                <p class="f14">We are glad to have you on board. You have taken the first step by signing up, now to complete registration, kindly make the mandatory registration fee payment of <b>N2,600.00</b>. Please, note this covers your contribution for 2 weeks.</p>
                ...
                <div class="row mt-3">
                    <div class="col-md-5">
                        ...
                        <button type="button" class="btn btn-primary mt-3"  disabled>Pay with paystack</button><p class="text-muted my-2">Coming Soon</p>
                    </div>
                    <div class="col-md-7">
                    <h6 class="f16 pt-sm-3 pt-md-0">Bank Transfer</h6>
                        <hr class="mt-1 mb-2" />
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered border f14">
                                <tbody>
                                    <tr>
                                        <th>Bank Name</th>
            ...
            <div class="alert alert-info" id="pendDiv" style="display: none;">
            <h4>Welcome <?= $session->get('identity')['first_name'] ?>!</h4>
...
<div class="row">
    ...
    <!-- <?= $session->get('identity')['registration_confirmed'] ? 'YES' : 'NO'; ?>
    <?= $session->get('identity')['has_account'] ? 'YES' : 'NO'; ?> -->
